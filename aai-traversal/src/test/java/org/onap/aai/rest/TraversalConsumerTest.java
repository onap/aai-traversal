...
//    @Test
//    public void getTraversalSource() throws AAIException {
//        SubgraphStrategy strategy = null;
//        Set<String> roles = Set.of("ROLE_ADMIN", "ROLE_USER");
//        long startTs = 1638336000000L;
//        long endTs = 1638422400000L;
//        Format format = Format.state;
//        doReturn(true).when(traversalConsumer).isHistory(format);
//        when(dbEngine.asAdmin()).thenReturn(admin);
//        when(admin.getReadOnlyTraversalSource()).thenReturn(source);
//        when(traversalConsumer.getSubgraphStrategy(startTs,endTs,format)).thenReturn(strategy);
//        GraphTraversalSource source = traversalConsumer.getTraversalSource(dbEngine,format,queryParameters,roles);
//        assertNotNull(source, "TraversalSource should not be null.");
//    }

...
public class DslConsumer extends TraversalConsumer {
    ...
    @Autowired
    public DslConsumer(DslConsumerService dslConsumerService, @Qualifier("requestScopedTraversalUriHttpEntry") HttpEntry requestScopedTraversalUriHttpEntry, XmlFormatTransformer xmlFormatTransformer) {
